...
class SignatureKeyType(object):
    ...
    def lookup(cls, name):
        ...
        :raises: clictest.common.exception.SignatureVerificationError if
...
def create_verifier_for_pss(signature, hash_method, public_key):
    ...
    :raises clictest.common.exception.SignatureVerificationError: if the
...
def get_verifier(context, image_properties):
    ...
    :raises clictest.common.exception.SignatureVerificationError: if building
            the verifier fails
    """
...
def get_public_key(context, signature_certificate_uuid, signature_key_type):
    ...
    :raises clictest.common.exception.SignatureVerificationError: if public
