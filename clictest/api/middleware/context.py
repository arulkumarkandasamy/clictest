...
import clictest.context
from clictest.i18n import _, _LW
...
class ContextMiddleware(BaseContextMiddleware):
    ...
    def process_request(self, req):
        ...
        Generate a clictest.context.RequestContext object from the available
    ...
    def _get_anonymous_context(self):
        ...
        return clictest.context.RequestContext(**kwargs)
...
class UnauthenticatedContextMiddleware(BaseContextMiddleware):
    def process_request(self, req):
        ...
        req.context = clictest.context.RequestContext(**kwargs)
